import{c as n}from"./app.b2da6103.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h2 id="\u624B\u5199array-prototype-reduce" tabindex="-1"><a class="header-anchor" href="#\u624B\u5199array-prototype-reduce" aria-hidden="true">#</a> \u624B\u5199Array.prototype.reduce</h2><p><a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce#polyfill" target="_blank" rel="noopener noreferrer">MDN-Array.prototype.reduce-Polyfill</a></p><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span><span class="token class-name">Array</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span>reduce<span class="token punctuation">)</span> <span class="token punctuation">{</span>
